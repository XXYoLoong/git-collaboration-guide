...
游龙（倪家诚），持续从事 HarmonyOS / ArkUI 应用开发、AI 能力集成、Web 全栈工程实现与智能体系统构建。项目实践覆盖软件落地的完整链路，包括面向产品的界面开发、后端服务实现、接口集成、部署上线与持续迭代。当前工作主要围绕智慧健康、智能交互、效率工具与场景化软件系统展开。更多项目与持续更新内容见 yoloong.com 与 harmonycare.cn。
